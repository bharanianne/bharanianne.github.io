    ...
    <div id="logo"> 
      ...
      <div style="position:absolute; left:36px;  top:80px;"> 
        <div align="left"><font color="#FFFFFF" size="5"><strong><b>CLOUD DATA PROTECTION 
            ...
            <div id="menu">
				<ul>
				<li class="current"><a href="key33.jsp"><b>USER</b></a></li>
  ...
  <div class="box"> <br>
    ...
    <div id="menu"> 
	  ...
	  style="text-decoration:underline">User Data</font></em></strong> <br/>
          <br>
        <form name="s" action="file_view222.jsp" method="get" onSubmit="return valid()">
          <table align="center" >
            <tr> 
              ...
              <td>&nbsp;&nbsp;&nbsp;<font face="Times New Roman"  size="+1" color="#CC3333"><strong> 
                <%=keyyy%>
                </strong></font> </td>
            </tr>
            <tr> 
