...
<body>
    ...
    <div id="logo"> 
      ...
      <div style="position:absolute; left:36px;  top:80px;"> 
        <div align="left"><font color="#FFFFFF" size="5"><strong><b>CLOUD DATA PROTECTION 
            ...
            <div id="menu">
				<ul>
				<li class="current"><a href="tpa.jsp"><b>AUDITOR</b></a></li>
  ...
  <div class="box"> <br>
    ...
    <p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <strong><font color="#990000" size="+1" face="Times New Roman" 
	  style="text-decoration:underline">Auditor Login</font></strong> <br/>
      <br>
    <form name="s" action="tpa1.jsp" method="get" onsubmit="return valid()">
      <table align="left" width="400" height="200" background="images/02.jpg">
        ...
        <tr> 
		  ...
		  <div style="position:absolute; left:620px;  top:250px;"> 
