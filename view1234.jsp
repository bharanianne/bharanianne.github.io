...
<html >
    ...
    <body>
        ...
        <div id="container">  	  
            <div id="header">
                ...
                <div id="menu">
                    <ul>
                        ...
                        <li><a href="admin_view2.jsp"><b>HOME</b></a></li>
                        ...
                        <form name="s" action="#" method="get" onSubmit="return valid()">
                            <table align="center"  width="380">
                                <tr> 
                                    ...
                                    <td><input type="text" name="key"> <a href="view123.jsp"><font face="Times New Roman"  size="+1" color="#CC0000"><strong>Data 
            ...
            <div style="position:absolute; left:826px;  top:290px;"> 
                <img src="images1/Best-Cloud-Storage.jpg" width="220" height="200"></div> 
